...
public class RegistrationSteps {
    ...
    public void user_creates_account_with_following_fields(List<Map<String, String>> registrationPageTestDataListMap) {
       registrationPage.fillOutRegistrationForm(registrationPageTestDataListMap);
    }
    ...
    @Then("the User see  the {string} required field error message {string}")
    public void the_user_see_the_required_field_error_message(String fieldName, String expectedErrorMessage) {
    ...
    public void theFollowingUserInfoShouldBeSavedInTheDb(List<Map<String, String>>expectedUserProfileInfoInDBList) {
        ...
        assertEquals(expectedUserInfoMap.get("credentialsNonExpired"),String.valueOf(actualUserInfoMap.get("credential_non_expired")),"credentialsNonExpired mismatch upon registration");

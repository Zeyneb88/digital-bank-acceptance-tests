...
public class RestHttpRequest {
    ...
    public static Response sendPostRequestWithPathParam(String endPoint, String pathParamId, Object pathParamVal,String body){
       return requestSpecification
                .body(body)
                .pathParam(pathParamId, pathParamVal)
                .when()
                .post(endPoint);

...
public class DataTableTransformer {
    ...
    @DataTableType
    public UserDomainForDataTable accountCardEntry(Map<String, String> entry){
        ...
        return new UserDomainForDataTable(title, firstName, lastName, gender, dob, ssn, emailAddress, password, address, locality, region, postalCode, country, homePhone, mobilePhone,workPhone);
    }
    @DataTableType
